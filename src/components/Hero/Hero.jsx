...
import Image1 from "../../assets/hero/DSC_0041-removebg-preview.png";
                  ...
                  <div className="order-1 sm:order-2">
                    ...
                    >
                      <img
                        src={data.img}
                        alt=""
                        className="w-[500px] sm:w-[450px] h-[300px] sm:h-[450px] sm:scale-105 lg:scale-120 object-contain mx-auto relative z-40"
                      />
                    </div>
                  </div>
                </div>
